 ...
 */
public class TextCreator extends BaseDemoActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtFileName = (EditText) findViewById(R.id.txtTitle);
        ...
        public void onResult(DriveContentsResult result) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        writer.write(textToSave.getText().toString());
                        writer.close();
                    } catch (IOException e) {
                        Log.e(TAG, e.getMessage());
                    }

                    MetadataChangeSet changeSet = new MetadataChangeSet.Builder().setTitle(txtFileName.getText().toString()).setMimeType("text/plain").setStarred(true).build();
